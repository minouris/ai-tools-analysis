...
- [GitHub Copilot: Claude Integration Deep Dive](github-copilot-claude-integration.md) - Deep dive into how Copilot integrates with Claude, including the Claude Agent SDK delegation mode, CLAUDE.md support, and Agent Skills compatibility
